...
class Workbook(xmlwriter.XMLwriter):
    ...
    def _store_workbook(self):
        ...
        # Prepare the drawings, charts and description.
    ...
    def _prepare_drawings(self):
        ...
        for sheet in self.worksheets():
            ...
            # Don't increase the drawing_id header/footer description.
            ...
            # Prepare the worksheet description.
            ...
            # Prepare the footer description.
    ...
    def _get_image_properties(self, filename, image_data):
        ...
        # Set a default dpi for description with 0 dpi.
        if x_dpi == 0:
            x_dpi = 96
        if y_dpi == 0:
            y_dpi = 96
