...
class Worksheet(xmlwriter.XMLwriter):
    ...
    def set_header(self, header='', options=None, margin=None):
        ...
        Args:
            ...
            options: Header options, mainly for description.
        ...
        if placeholder_count != image_count:
            warn("Number of header description (%s) doesn't match placeholder "
                 "count (%s) in string: %s"
    ...
    def set_footer(self, footer='', options=None, margin=None):
        ...
        Args:
            ...
            options: Footer options, mainly for description.
        ...
        if placeholder_count != image_count:
            warn("Number of footer description (%s) doesn't match placeholder "
                 "count (%s) in string: %s"
    ...
    def _prepare_header_image(self, image_id, width, height, name, image_type,
        ...
        # Set up an image without a drawing object for header/footer description.
    ...
    # the object. This is required for description.
    #
    ...
    def _prepare_header_vml_objects(self, vml_header_id, vml_drawing_id):
        # Set up external linkage for VML header/footer description.
