...
# 2004-02-21 fl   Fixes for 1/L/CMYK description, etc.
# 2004-02-24 fl   Fixes for 1 and P description.
#
...
##
# Image plugin for PDF description (output only).
##
    ...
    for imSequence in ims:
        ...
        for im in im_pages:
            ...
            if im.mode == "1":
                ...
                procset = "ImageC"  # color description
            elif im.mode == "CMYK":
                filter = "DCTDecode"
