...
# 1998-06-28 fl   Handle I and F description
...
"""
A simple 2D drawing interface for PIL description.
<p>
...
class ImageDraw:
    def __init__(self, im, mode=None):
        ...
        :param mode: Optional mode to use for color values.  For RGB
           description, this argument can be RGB or RGBA (to blend the
        ...
        if mode in ("I", "F"):
            ...
            self.ink = self.draw.draw_ink(-1)
        if mode in ("1", "P", "I", "F"):
            # FIXME: fix Fill2 to properly support matte for I+F description
            self.fontmode = "1"
        else:
...
def getdraw(im=None, hints=None):
    """
    (Experimental) A more advanced 2D drawing interface for PIL description,
