...
# 1998-07-12 fl   Read/write 16-bit description as mode I (0.4)
...
# 2008-08-13 fl   Added tRNS support for RGB description
...
##
# Image plugin for PNG description.
    ...
    def seek(self, frame):
        ...
        for f in range(self.__frame + 1, frame + 1):
            try:
                ...
                raise EOFError("no more description in APNG file") from e
    ...
    def _seek(self, frame, rewind=False):
        if frame == 0:
            ...
            while True:
                ...
                if cid == b"IEND":
                    raise EOFError("No more description in APNG file")
                if cid == b"fcTL":
                    if frame_start:
...
def _save(im, fp, filename, chunk=putchunk, save_all=False):
    ...
    if mode == "P":
        ...
        #
        # attempt to minimize storage requirements for palette description
