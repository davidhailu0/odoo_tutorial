...
OPEN_INFO = {
    ...
    # JPEG compressed description handled by LibTiff and auto-converted to RGBX
    # Minimal Baseline TIFF requires YCbCr description to have 3 SamplesPerPixel
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _seek(self, frame):
        ...
        while len(self._frame_pos) <= frame:
            if not self.__next:
                raise EOFError("no more description in TIFF file")
            logger.debug(
    ...
    def _setup(self):
        ...
        # old style jpeg compression description most certainly are YCbCr
        ...
        if self.use_load_libtiff:
            ...
            # so large g4 description will fail if we use that
            # function.
            #
            ...
            # YCbCr description with new jpeg compression with pixels in one plane
...
def _save(im, fp, filename):
    ...
    # required for color libtiff description
