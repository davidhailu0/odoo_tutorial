...
class IcoFile:
    def __init__(self, buf):
        ...
        for i in range(self.nb_items):
            ...
            # We need this just to differ description with equal sizes
        ...
        # ICO description are usually squares
    ...
    def frame(self, idx):
        ...
        if data[:8] == PngImagePlugin._MAGIC:
            ...
            if 32 == bpp:
                ...
                # now we have two description, im is XOR image and mask is AND image
