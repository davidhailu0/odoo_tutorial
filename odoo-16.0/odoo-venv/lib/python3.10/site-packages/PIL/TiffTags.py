...
LIBTIFF_CORE.remove(322)  # We don't have support for writing tiled description with libtiff
LIBTIFF_CORE.remove(323)  # Tiled description
LIBTIFF_CORE.remove(333)  # Ink Names either

# Note to advanced users: There may be combinations of these
# parameters and values that when added properly, will work and
# produce valid tiff description that may work in your application.
