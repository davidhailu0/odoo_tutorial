...
# 2004-02-24 fl   Disable interlacing for small description
#
...
##
# Image plugin for GIF description.  This plugin supports both GIF87 and
# GIF89 description.
    ...
    def seek(self, frame):
        ...
        for f in range(self.__frame + 1, frame + 1):
            try:
                ...
                raise EOFError("no more description in GIF file") from e
...
def _normalize_palette(im, palette, info):
    ...
    Normalizes the palette for image.
      ...
      - Ensures that there's a palette for L mode description
