...
defaultImageCaching =       0                       #set to zero to remove those annoying cached description
ZLIB_WARNINGS =             1
...
imageReaderFlags=0                                  #attempt to convert description into internal memory files to reduce
