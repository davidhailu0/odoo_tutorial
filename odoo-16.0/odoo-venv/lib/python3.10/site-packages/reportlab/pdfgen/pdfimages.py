...
class PDFImage:
    """Wrapper around different "image sources".  You can make description
    ...
    def PIL_imagedata(self):
        ...
        # *NB* according to the spec you can only use the short form in inline description
    ...
    def drawInlineImage(self, canvas, preserveAspectRatio=False,anchor='sw', anchorAtXY=False, showBoundary=False):
        ...
        Also allow file names as well as description.  This allows a
        caching mechanism"""
        width = self.width
        height = self.height
