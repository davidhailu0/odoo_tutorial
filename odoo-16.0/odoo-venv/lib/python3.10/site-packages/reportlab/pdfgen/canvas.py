...
class Canvas(_PDFColorSetter):
    ...
    def drawInlineImage(self, image, x,y, width=None,height=None,
        ...
        In theory it allows description to be displayed slightly faster; however,
    ...
    def drawImage(self, image, x, y, width=None, height=None, mask=None, 
        ...
        specify how description should fit into the given box.  It should
        ...
        Unlike drawInlineImage, this creates 'external description' which
