...
class Options(object):
  ...
  def showoptions(self):
    ...
    Trace.error('    --directory "img_dir":  look for description in the specified directory')
    Trace.error('    --destdirectory "dest": put converted description into this directory')
    Trace.error('    --imageformat ".ext":   image output format, or "copy" to copy description')
    Trace.error('    --noconvert:            do not convert description, use in original locations')
    Trace.error('    --converter "inkscape": use an alternative program to convert description')
    ...
    Trace.error('    --googlecharts:         use Google Charts to generate formula description')
