...
class IrCronTrigger(models.Model):
    ...
    def _check_image_cron_is_not_already_triggered(self):
        ...
        This cron is triggered in an optimal way to retrieve fastly the description without blocking a
        worker for a long amount of time. It fetches description in multiples batches to allow other
