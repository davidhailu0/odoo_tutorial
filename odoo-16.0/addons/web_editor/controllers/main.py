...
class Web_Editor(http.Controller):
    ...
    def get_image_info(self, src=''):
        ...
        if not attachment:
            ...
            # snippet description referencing the same image in /static/, so we limit to 1
    ...
    def modify_image(self, attachment, res_model=None, res_id=None, name=None, data=None, original_id=None, mimetype=None):
        ...
        if attachment.url:
            # Don't keep url if modifying static attachment because static description
    ...
    def save_library_media(self, media):
        """
        Saves description from the media library as new attachments, making them
