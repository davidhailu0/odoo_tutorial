...
class WebsiteSale(http.Controller):
    ...
    @http.route(['/shop/product/extra-description'], type='json', auth='user', website=True)
    def add_product_images(self, images, product_product_id, product_template_id, combination_ids=None):
        """
        Turns a list of image ids refering to ir.attachments to product.description,
    ...
    @http.route(['/shop/product/clear-description'], type='json', auth='user', website=True)
    def clear_product_images(self, product_product_id, product_template_id):
        """
        Unlinks all description from the product.
        """
        if not request.env.user.has_group('website.group_website_restricted_editor'):
            raise NotFound()
