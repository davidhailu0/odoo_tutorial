...
class Product(models.Model):
    ...
    def _get_images(self):
        ...
        if self.image_variant_1920:
            ...
            # image, in this case insert it after the other variant description, so
            # that all variant description are first and all template description last.
            variant_images = variant_images + [self]
        # [1:] to remove the main image from the template, we only display
        # the template extra description here
