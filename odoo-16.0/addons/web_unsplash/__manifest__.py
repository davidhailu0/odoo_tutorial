...
# Part of Odoo. See LICENSE file for full copyright and licensing details.
{
    ...
    'category': 'Hidden',
    'summary': 'Find free high-resolution description from Unsplash',
    'version': '1.1',
    'description': """Explore the free high-resolution image library of Unsplash.com and find description to use in Odoo. An Unsplash search bar is added to the image library modal.""",
